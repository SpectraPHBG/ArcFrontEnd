...
export function FormFactorPopover () {
    ...
    const formFactorTooltip = (
        <Popover className='bg-light' id= 'formFactorPopover'
            ...
            <Popover.Body>
                ...
                <p>
                    The PC case form factor refers to the physical design and size of a computer case.
                    It determines the shape, dimensions, and layout of the case, including the motherboard size and the number of expansion slots available.
                </p>
            </Popover.Body>
        </Popover>
    );
